...
def init_db():
    ...
    c = conn.cursor()
    # Menghapus tabel lama agar struktur kolom baru pas (hanya saat pertama kali perbaikan)
    # Hapus baris di bawah ini nanti jika database sudah stabil
...
with tab1:
    with st.form("input_form", clear_on_submit=True):
        ...
        with c1:
            ...
            # Item Type dipisah sesuai permintaan bos
        ...
        if st.form_submit_button("Simpan Data"):
            ...
            conn = sqlite3.connect('assets.db')
            try:
                # Query diperbaiki jumlah tanda tanyanya (25 kolom)
