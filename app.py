...
def init_db():
    ...
    c = conn.cursor()
    # Menambah 2 kolom baru: last_movement, last_update
    c.execute('''CREATE TABLE IF NOT EXISTS assets (
                    ...
                    po_number TEXT, purchase_date TEXT, purchase_price REAL, 
                    qr_code TEXT, qty INTEGER, remark TEXT, serial_number TEXT, 
