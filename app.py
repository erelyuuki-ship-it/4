...
def init_db():
    # Database ini bersifat permanen, tidak akan di-drop/dihapus
...
with tab1:
    with st.form("input_form", clear_on_submit=False):
        ...
        with c2:
            ...
            # HANYA UPLOAD (Kamera di-handle oleh fitur HP)
    ...
    # QR & PRINT (Di luar form agar tidak error)
...
with tab2:
    ...
    # Kamera untuk scan tetap ada di sini (tab search)
    cam_scan = st.camera_input("Nyalakan Kamera")
    st.divider()
